...
class Login extends Component {
    handleSubmit(evt){
        evt.preventDefault()
        this.props.login(evt.target.children[0].value)
        }
    componentDidMount () {
            this._input.focus();
          }
